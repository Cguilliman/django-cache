...
DEFAULT_LAZY_INVALIDATION = getattr(settings, "DJANGO_CACHE_DEFAULT_LAZY_INVALIDATION", False)
DEFAULT_DELAY_LAZY_INVALIDATION = getattr(settings, "DJANGO_CACHE_DEFAULT_DELAY_LAZY_INVALIDATION", False)
